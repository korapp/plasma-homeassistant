...
GridLayout {
    ...
    readonly property int itemSize: {
        ...
        return PlasmaCore.Units.roundToIconSize(Math.min(Math.min(width, height) / rowsOrColumns, PlasmaCore.Units.iconSizes.enormous))
    }
    ...
    Repeater {
        ...
        delegate: EntityWrapper {
            ...
            showScrollPositionBackground: false
