        ...
        Loader {
            ...
            sourceComponent: Component {
                Item {
                    ...
                    property var selector: { selector = store.getFieldSelector(scroll_action, attributes) }
                    readonly property real attributeBasedPosition: selector.scale(attributes[selector.attribute])
                    ...
                    WheelHandler {
                        ...
                        onActiveChanged: !active && callService(scroll_action, { [scroll_action.data_field]: selector.inverseScale(position) })
                    }
                    Rectangle {
